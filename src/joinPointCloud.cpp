...
{
  string file ="/home/tribbiani/rgbd-slam/parameters.txt";
  ...
  computeKeyPointAndDesp( frame1, detector, descriptor );
  computeKeyPointAndDesp( frame2, detector, descriptor );
  ...
  *output += *cloud2;
  pcl::io::savePCDFile( "data/result_of_chaptr4.pcd", *output );
